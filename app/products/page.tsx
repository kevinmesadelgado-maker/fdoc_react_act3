          ...
          <div key={product.id} className="border rounded-lg p-4 shadow-md">
            ...
            <div className="mt-4 space-y-2">
              <Link 
                ...
                className="block bg-blue-500 text-black px-4 py-2 rounded text-center hover:bg-blue-600"
              >
                Ver Detalles
              </Link>
              <Link 
                href={`/categories/${product.category}/products/${product.id}`}
                className="block bg-green-500 text-black px-4 py-2 rounded text-center hover:bg-green-600"
              >
                Ver en Categoría
              </Link>
            </div>
